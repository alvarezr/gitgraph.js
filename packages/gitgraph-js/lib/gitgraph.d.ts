import { GitgraphOptions, GitgraphCommitOptions, MergeStyle, Mode, BranchUserApi, GitgraphBranchOptions, GitgraphTagOptions, GitgraphMergeOptions, Orientation, TemplateName, templateExtend } from "@sourceflow/gitgraph-core";
...
declare function createGitgraph(graphContainer: HTMLElement, options?: GitgraphOptions & {
    responsive?: boolean;
}): import("@sourceflow/gitgraph-core/lib/user-api/gitgraph-user-api").GitgraphUserApi<SVGElement>;
