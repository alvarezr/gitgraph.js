!(function (t, e) {
  ...
  var i = s(function (t, e) {
    Object.defineProperty(e, "__esModule", { value: !0 }),
      (function (t) {
        (t.VerticalReverse = "vertical-reverse"),
          (t.Horizontal = "horizontal"),
          (t.HorizontalReverse = "horizontal-reverse");
  ...
  var n = s(function (t, e) {
    function r(t, e) {
      return Object.assign(
        {},
        e.reduce((e, r) => Object.assign({}, e, { [r]: t[r] }), {}),
      );
    }
    function s(t) {
      return void 0 === t;
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
      ...
      (e.isUndefined = s),
      (e.withoutUndefinedKeys = function (t = {}) {
        return Object.keys(t).reduce(
          (e, r) => (s(t[r]) ? e : Object.assign({}, e, { [r]: t[r] })),
          {},
        );
      }),
  ...
  var a = s(function (t, e) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
      ...
      (e.MergeStyle = r),
      (e.DEFAULT_FONT = "normal 12pt Calibri");
    class s {
      constructor(t) {
        (t.branch = t.branch || {}),
          (t.branch.label = t.branch.label || {}),
          (t.arrow = t.arrow || {}),
          (t.commit = t.commit || {}),
          (t.commit.dot = t.commit.dot || {}),
          (t.commit.message = t.commit.message || {}),
          (this.colors = t.colors || ["#000000"]),
          (this.branch = {
            ...
            label: {
              ...
              font:
                t.branch.label.font || t.commit.message.font || e.DEFAULT_FONT,
          ...
          (this.commit = {
            ...
            hasTooltipInCompactMode: n.booleanOptionOr(
              t.commit.hasTooltipInCompactMode,
              !0,
            ),
            dot: {
              ...
              font:
                t.commit.dot.font ||
                t.commit.message.font ||
                "normal 10pt Calibri",
            },
            message: {
              display: n.booleanOptionOr(t.commit.message.display, !0),
              displayAuthor: n.booleanOptionOr(
                t.commit.message.displayAuthor,
                !0,
              ),
    ...
    const i = new s({
      ...
      commit: {
        spacing: 60,
        dot: { size: 16, strokeColor: "#000000", strokeWidth: 4 },
        message: { color: "black" },
      },
      arrow: { size: 16, offset: -1.5 },
    });
    e.blackArrowTemplate = i;
    const a = new s({
      colors: ["#979797", "#008fb5", "#f1c109"],
      branch: { lineWidth: 10, spacing: 50 },
      commit: {
        spacing: 80,
        dot: { size: 14 },
  ...
  var h = s(function (t, e) {
    ...
    class s {
      constructor(t) {
        ...
        (this.author = { name: e, email: s, timestamp: Date.now() }),
          (this.committer = { name: e, email: s, timestamp: Date.now() }),
          (this.subject = t.subject),
          (this.body = t.body || ""),
          (this.hash = t.hash || r()),
          (this.hashAbbrev = this.hash.substring(0, 7)),
          (this.parents = t.parents ? t.parents : []),
          (this.parentsAbbrev = this.parents.map((t) => t.substring(0, 7))),
          (this.style = Object.assign({}, t.style, {
            message: Object.assign({}, t.style.message),
            dot: Object.assign({}, t.style.dot),
          })),
          (this.dotText = t.dotText),
          (this.onClick = () => (t.onClick ? t.onClick(this) : void 0)),
          (this.onMessageClick = () =>
            t.onMessageClick ? t.onMessageClick(this) : void 0),
          (this.onMouseOver = () =>
            t.onMouseOver ? t.onMouseOver(this) : void 0),
          (this.onMouseOut = () =>
            t.onMouseOut ? t.onMouseOut(this) : void 0),
          (this.renderDot = t.renderDot),
          (this.renderMessage = t.renderMessage),
          (this.renderTooltip = t.renderTooltip);
      }
      get message() {
        let t = "";
        return (
          this.style.message.displayHash && (t += `${this.hashAbbrev} `),
          (t += this.subject),
          this.style.message.displayAuthor &&
            (t += ` - ${this.author.name} <${this.author.email}>`),
          t
        );
      }
      get branchToDisplay() {
      ...
      setTags(t, e, r) {
        return (
          (this.tags = t
            .getNames(this.hash)
            .map((t) => new o.Tag(t, e(t), r(t), this.style))),
          this
        );
      }
      setBranches(t) {
      ...
      withDefaultColor(t) {
        ...
        e.color || (e.color = t),
          e.dot.color || (e.dot.color = t),
          e.message.color || (e.message.color = t);
  ...
  var c = s(function (t, r) {
    ...
    class i {
      ...
      branch(t) {
        ...
        const e = "string" == typeof t ? { name: t } : t;
      ...
      commit(t) {
        ...
        return (
          "string" == typeof t && (t = { subject: t }),
          t || (t = {}),
          this._commitWithParents(t, []),
          this._onGraphUpdate(),
          this
        );
      }
      delete() {
        ...
        return (
          [
            ...(function* (t, e) {
              const r = (t, e) => t.commits.find(({ hash: t }) => t === e);
              let s = r(t, t.refs.getCommit(e.name));
              for (; s && s.hash !== e.parentCommitHash; )
                yield s, (s = r(t, s.parents[0]));
          ...
          (this._branch = l.createDeletedBranch(
            this._graph,
            this._branch.style,
            () => {},
          )),
      ...
      merge(...t) {
        ...
        (function (t) {
          ...
          (e = {
            branch: t[0],
            fastForward: !1,
            commitOptions: { subject: t[1] },
          });
        const { branch: r, fastForward: s, commitOptions: n } = e,
          a = "string" == typeof r ? r : r.name,
          o = this._graph.refs.getCommit(a);
      ...
      tag(t) {
        ...
        return (
          "string" == typeof t
            ? this._graph.getUserApi().tag({ name: t, ref: this._branch.name })
            : this._graph
                .getUserApi()
                .tag(Object.assign({}, t, { ref: this._branch.name })),
          this
        );
      }
      checkout() {
        ...
        return (
          (this._graph.currentBranch = t),
          e && this._graph.refs.set("HEAD", e),
          this
        );
      }
      _commitWithParents(t, e) {
        ...
        r
          ? e.unshift(r)
          : this._branch.parentCommitHash &&
            e.unshift(this._branch.parentCommitHash);
        const { tag: i } = t,
          n = s(t, ["tag"]),
          a = new h.Commit(
            Object.assign(
              ...
              n,
              { parents: e, style: this._getCommitStyle(t.style) },
            ),
          );
        if (r) {
          this._graph.refs
            .getNames(r)
            .forEach((t) => this._graph.refs.set(t, a.hash));
      ...
      _areCommitsConnected(t, e) {
        const r = this._graph.commits.find(({ hash: t }) => e === t);
        return (
          !!r &&
          !(0 === r.parents.length) &&
          (!!r.parents.includes(t) ||
            r.parents.some((e) => this._areCommitsConnected(t, e)))
        );
      }
      _fastForwardTo(t) {
      ...
      _getCommitStyle(t = {}) {
        return Object.assign(
          {},
          n.withoutUndefinedKeys(this._graph.template.commit),
          n.withoutUndefinedKeys(this._branch.commitDefaultOptions.style),
          t,
          {
            message: Object.assign(
              {},
              n.withoutUndefinedKeys(this._graph.template.commit.message),
              n.withoutUndefinedKeys(
            ...
            dot: Object.assign(
              {},
              n.withoutUndefinedKeys(this._graph.template.commit.dot),
              n.withoutUndefinedKeys(
  ...
  var l = s(function (t, e) {
    ...
    class s {
      constructor(t) {
        (this.gitgraph = t.gitgraph),
          (this.name = t.name),
          (this.style = t.style),
          (this.parentCommitHash = t.parentCommitHash),
          (this.commitDefaultOptions = t.commitDefaultOptions || { style: {} }),
          (this.onGraphUpdate = t.onGraphUpdate),
          (this.renderLabel = t.renderLabel);
      }
      getUserApi() {
    ...
    (e.Branch = s),
      (e.createDeletedBranch = function (t, e, i) {
        return new s({ name: r, gitgraph: t, style: e, onGraphUpdate: i });
      });
  });
  r(l);
  ...
  var u = s(function (t, e) {
    ...
    e.RegularGraphRows = class {
      ...
      getMaxRow() {
        return (
          void 0 === this.maxRowCache &&
            (this.maxRowCache =
              (function (t) {
                const e = new Set();
                return t.forEach((t) => e.add(t)), Array.from(e);
              })(Array.from(this.rows.values())).length - 1),
          this.maxRowCache
        );
      }
  ...
  var d = s(function (t, e) {
    Object.defineProperty(e, "__esModule", { value: !0 });
    e.CompactGraphRows = class extends (
      u.RegularGraphRows
    ) {
      computeRowsFromCommits(t) {
        t.forEach((e, r) => {
          ...
          if (0 !== r) {
            const i = this.getRowOf(e.parents[0]),
              n = t[r - 1];
            (s = Math.max(i + 1, this.getRowOf(n.hash))),
              e.parents.length > 1 && i < this.getRowOf(e.parents[1]) && s++;
          }
  ...
  var p = s(function (t, e) {
    Object.defineProperty(e, "__esModule", { value: !0 }),
      (e.GraphRows = u.RegularGraphRows),
      (e.createGraphRows = function (t, e) {
        return t === m.Mode.Compact
          ? new d.CompactGraphRows(e)
          : new u.RegularGraphRows(e);
      });
  });
  r(p);
    ...
    e.BranchesOrder = class {
      constructor(t, e, r) {
        (this.branches = new Set()),
          (this.colors = e),
          t.forEach((t) => this.branches.add(t.branchToDisplay)),
          r && (this.branches = new Set(Array.from(this.branches).sort(r)));
      }
      get(t) {
  ...
  var f = s(function (t, e) {
    ...
    e.Refs = class {
      ...
      set(t, e) {
        ...
        return (
          r && this.removeNameFrom(r, t),
          this.addNameTo(e, t),
          this.addCommitTo(t, e),
          this
        );
      }
      delete(t) {
        return (
          this.hasName(t) &&
            (this.removeNameFrom(this.getCommit(t), t),
            this.commitPerName.delete(t)),
          this
        );
      }
      getCommit(t) {
    ...
    (e.BranchesPathsCalculator = class {
      constructor(t, e, r, s, i, n) {
        (this.branchesPaths = new Map()),
          (this.commits = t),
          (this.branches = e),
          (this.commitSpacing = r),
          (this.isGraphVertical = s),
          (this.isGraphReverse = i),
          (this.createDeletedBranch = n);
      }
      execute() {
        return (
          this.fromCommits(),
          this.withMergeCommits(),
          this.smoothBranchesPaths()
        );
      }
      fromCommits() {
        this.commits.forEach((t) => {
          ...
          e ||
            (e = this.getDeletedBranchInPath() || this.createDeletedBranch());
          const r = [],
            s = this.branchesPaths.get(e),
            i = this.commits.find(({ hash: e }) => e === t.parents[0]);
          s ? r.push(...s) : i && r.push({ x: i.x, y: i.y }),
            r.push({ x: t.x, y: t.y }),
      ...
      withMergeCommits() {
        this.commits
          .filter(({ parents: t }) => t.length > 1)
          .forEach((t) => {
            const e = this.commits.find(({ hash: e }) => e === t.parents[1]);
            if (!e) return;
            ...
            this.branchesPaths.set(s, [
              ...i,
              { x: t.x, y: t.y, mergeCommit: !0 },
            ]);
          });
      }
      ...
      smoothBranchesPaths() {
        const t = new Map();
        return (
          this.branchesPaths.forEach((e, r) => {
            if (e.length <= 1) return void t.set(r, [e]);
            (e = this.isGraphVertical
              ? e.sort((t, e) => (t.y > e.y ? -1 : 1))
              : e.sort((t, e) => (t.x > e.x ? 1 : -1))),
              this.isGraphReverse && (e = e.reverse());
            const s = e.reduce(
              (t, r, s) => {
                if (r.mergeCommit) {
            ...
            this.isGraphReverse && s.forEach((t) => t.reverse()),
              this.isGraphVertical
                ? s.forEach((e) => {
                    ...
                    const s = e[0],
                      ...
                      n = e[1].x,
                      a =
                        Math.round(Math.abs(s.y - i.y) / this.commitSpacing) -
                        1,
                      o =
                        a > 0
                          ? new Array(a)
                ...
                : s.forEach((e) => {
                    ...
                    const s = e[0],
                      ...
                      n = e[1].y,
                      a =
                        Math.round(Math.abs(s.x - i.x) / this.commitSpacing) -
                        1,
                      o =
                        a > 0
                          ? new Array(a)
  ...
  var y = s(function (t, e) {
    ...
    e.GitgraphUserApi = class {
      ...
      clear() {
        return (
          (this._graph.refs = new f.Refs()),
          (this._graph.tags = new f.Refs()),
          (this._graph.commits = []),
      ...
      tag(...t) {
        ...
        if (
          (this._graph.refs.hasCommit(r) && (n = r),
          this._graph.refs.hasName(r) && (n = this._graph.refs.getCommit(r)),
          !n)
        )
          throw new Error(`The ref "${r}" does not exist`);
        return (
          this._graph.tags.set(e, n),
          (this._graph.tagStyles[e] = s),
          (this._graph.tagRenders[e] = i),
          this._onGraphUpdate(),
          this
        );
      }
      import(t) {
        ...
        const r = t
          ...
          .reverse();
        this.clear(),
          (this._graph.commits = r.map((t) => new h.Commit(t))),
          r.forEach(({ refs: t, hash: e }) => {
            t &&
              e &&
              (t
                .map((t) => t.split("tag: "))
                ...
                .forEach((t) => this._graph.tags.set(t, e)),
              t
                .filter((t) => !t.startsWith("tag: "))
                .forEach((t) => this._graph.refs.set(t, e)));
          });
        const s = this._getBranches();
        return (
          this._graph.commits
            .map((t) => this._withBranches(s, t))
            .reduce(
              (t, e) =>
                e.branches ? (e.branches.forEach((e) => t.add(e)), t) : t,
              new Set(),
            )
            .forEach((t) => this.branch(t)),
          this._onGraphUpdate(),
          this
        );
      }
      _withBranches(t, e) {
        ...
        return (
          0 === r.length && (r = [l.DELETED_BRANCH_NAME]), e.setBranches(r)
        );
      }
      _getBranches() {
        const t = new Map(),
          ...
          this._graph.refs
            ...
            .forEach((r) => {
              ...
              for (s && e.push(s); e.length > 0; ) {
                const s = e.pop(),
                  i = this._graph.commits.find(({ hash: t }) => t === s),
                  n = t.get(s) || new Set();
                n.add(r),
                  t.set(s, n),
                  i &&
  ...
  var v = s(function (t, e) {
    ...
    e.GitgraphCore = class {
      constructor(t = {}) {
        (this.refs = new f.Refs()),
          (this.tags = new f.Refs()),
          (this.tagStyles = {}),
          (this.tagRenders = {}),
          (this.commits = []),
          ...
          (this.template = a.getTemplate(t.template)),
          (this.currentBranch = this.createBranch("master")),
          (this.orientation = t.orientation),
          (this.reverseArrow = n.booleanOptionOr(t.reverseArrow, !1)),
          (this.initCommitOffsetX = n.numberOptionOr(t.initCommitOffsetX, 0)),
          (this.initCommitOffsetY = n.numberOptionOr(t.initCommitOffsetY, 0)),
          (this.mode = t.mode),
          (this.author = t.author || "Sergio Flores <saxo-guy@epic.com>"),
          (this.commitMessage =
            t.commitMessage || "He doesn't like George Michael! Boooo!"),
          (this.generateCommitHash =
            "function" == typeof t.generateCommitHash
              ? t.generateCommitHash
              : () => void 0),
          (this.branchesOrderFunction =
            "function" == typeof t.compareBranchesOrder
              ? t.compareBranchesOrder
              : void 0),
          (this.branchLabelOnEveryCommit = n.booleanOptionOr(
            t.branchLabelOnEveryCommit,
            !1,
          ));
      }
      get isHorizontal() {
        return (
          this.orientation === i.Orientation.Horizontal ||
          this.orientation === i.Orientation.HorizontalReverse
        );
      }
      get isVertical() {
      ...
      get isReverse() {
        return (
          this.orientation === i.Orientation.HorizontalReverse ||
          this.orientation === i.Orientation.VerticalReverse
        );
      }
      ...
      getRenderedData() {
        ...
        return (
          this.computeBranchesColor(t, e),
          { commits: t, branchesPaths: e, commitMessagesX: r }
        );
      }
      createBranch(t) {
        let e = {
        ...
        if ("string" == typeof t)
          (e.name = t), (e.parentCommitHash = this.refs.getCommit("HEAD"));
        else {
          const r = t.from ? t.from.name : "HEAD",
            s =
              this.refs.getCommit(r) ||
              (this.refs.hasCommit(t.from) ? t.from : void 0);
          (t.style = t.style || {}),
            (e = Object.assign({}, e, t, {
              parentCommitHash: s,
      ...
      computeRenderedCommits() {
        const t = this.getBranches(),
          e = (() => {
            const e = new Set(
                this.commits.reduce(
                  (e, { hash: r }) => (t.has(r) ? e : [...e, r]),
                  [],
                ),
              ),
              r = this.commits.reduce(
                (t, e) =>
                  e.parents.length > 1
                    ? [
                        ...t,
              ...
              r.forEach((t) => {
                ...
                for (; r && e.has(r.hash); )
                  s.add(r.hash),
                    (r =
                      r.parents.length > 0
                        ? this.commits.find(({ hash: t }) => r.parents[0] === t)
                        : void 0);
              }),
              s
            );
          })(),
          r = this.commits.filter(({ hash: r }) => t.has(r) || e.has(r)),
          s = r.map((e) => this.withBranches(t, e)),
          i = p.createGraphRows(this.mode, r),
          n = new g.BranchesOrder(
            s,
            this.template.colors,
            this.branchesOrderFunction,
          );
        return s
          .map((t) => t.setRefs(this.refs))
          .map((t) => this.withPosition(i, n, t))
          .map((t) =>
            t.withDefaultColor(
              this.getBranchDefaultColor(n, t.branchToDisplay),
            ),
          )
          .map((t) =>
            t.setTags(
              this.tags,
              (t) => Object.assign({}, this.tagStyles[t], this.template.tag),
              (t) => this.tagRenders[t],
            ),
          );
      }
      computeRenderedBranchesPaths(t) {
        return new b.BranchesPathsCalculator(
          t,
          this.branches,
          ...
          this.isReverse,
          () =>
            l.createDeletedBranch(this, this.template.branch, () =>
              this.next(),
            ),
        ).execute();
      }
      computeBranchesColor(t, e) {
        const r = new g.BranchesOrder(
          t,
          this.template.colors,
          this.branchesOrderFunction,
        );
        Array.from(e).forEach(([t]) => {
          t.computedColor =
            t.style.color || this.getBranchDefaultColor(r, t.name);
        });
      }
        ...
        return (
          this.refs
            ...
            .forEach((r) => {
              ...
              for (s && e.push(s); e.length > 0; ) {
                const s = e.pop(),
                  i = this.commits.find(({ hash: t }) => t === s),
                  n = t.get(s) || new Set();
                n.add(r),
                  t.set(s, n),
                  i &&
        ...
        switch (this.orientation) {
          default:
            return r.setPosition({
              ...
              y:
                this.initCommitOffsetY + this.template.commit.spacing * (n - s),
            });
          case i.Orientation.VerticalReverse:
            return r.setPosition({
              x: this.initCommitOffsetX + this.template.branch.spacing * a,
          ...
          case i.Orientation.HorizontalReverse:
            return r.setPosition({
              x:
                this.initCommitOffsetX + this.template.commit.spacing * (n - s),
              y: this.initCommitOffsetY + this.template.branch.spacing * a,
            });
        }
      }
      ...
      next() {
        this.nextTimeoutId && window.clearTimeout(this.nextTimeoutId),
  ...
  var w = s(function (t, e) {
    Object.defineProperty(e, "__esModule", { value: !0 }),
      (e.GitgraphCore = v.GitgraphCore),
      (e.Mode = m.Mode),
      (e.GitgraphUserApi = y.GitgraphUserApi),
      (e.BranchUserApi = c.BranchUserApi),
      (e.Branch = l.Branch),
      (e.Commit = h.Commit),
      (e.Tag = o.Tag),
      (e.Refs = f.Refs),
      (e.MergeStyle = a.MergeStyle),
      (e.TemplateName = a.TemplateName),
      (e.templateExtend = a.templateExtend),
      (e.Orientation = i.Orientation),
      (e.toSvgPath = b.toSvgPath),
      (e.arrowSvgPath = n.arrowSvgPath);
  });
  r(w);
  ...
  function R(t) {
    ...
    return (
      ...
      t.fill && e.setAttribute("fill", t.fill),
      t.stroke && e.setAttribute("stroke", t.stroke),
      t.strokeWidth && e.setAttribute("stroke-width", t.strokeWidth.toString()),
      t.onClick && e.addEventListener("click", t.onClick),
      t.onMouseOver && e.addEventListener("mouseover", t.onMouseOver),
      t.onMouseOut && e.addEventListener("mouseout", t.onMouseOut),
      e
    );
  }
  function k(t) {
    ...
    return (
      ...
      t.fill && e.setAttribute("fill", t.fill),
      t.font && e.setAttribute("style", "font: " + t.font),
      t.anchor && e.setAttribute("text-anchor", t.anchor),
      t.translate &&
        (e.setAttribute("x", t.translate.x.toString()),
        e.setAttribute("y", t.translate.y.toString())),
      t.onClick && e.addEventListener("click", t.onClick),
      e
    );
  }
  ...
  function N(t, e) {
    var r = (function (t) {
        ...
        return (
          ...
          t.borderRadius && e.setAttribute("rx", t.borderRadius.toString()),
          t.fill && e.setAttribute("fill", t.fill || "none"),
          t.stroke && e.setAttribute("stroke", t.stroke),
          e
        );
      })({
    ...
    return (
      new MutationObserver(function () {
        ...
        r.setAttribute("width", i.toString()),
          r.setAttribute("height", n.toString()),
          s.setAttribute("y", (n / 2).toString());
      }).observe(i, { attributes: !1, subtree: !1, childList: !0 }),
      i.appendChild(s),
      i
    );
  }
  ...
  (t.MergeStyle = _),
    ...
    (t.createGitgraph = function (t, e) {
        ...
        c = (function (t) {
          ...
          return t
            ? (t.children &&
              ...
              t.viewBox && e.setAttribute("viewBox", t.viewBox),
              t.height && e.setAttribute("height", t.height.toString()),
              t.width && e.setAttribute("width", t.width.toString()),
              e)
            : e;
        })();
      (l = Boolean(e && e.responsive)),
        new MutationObserver(function () {
          var t, e, h;
          a
            ? ((a = !1),
              (t = Array.from(s.children)),
              (e = 0),
              (h = m.orientation === x.VerticalReverse ? t : t.reverse()),
              (n = h.reduce(function (t, r) {
                var s = parseInt(
                    r.getAttribute("transform").split(",")[1].slice(0, -1),
                    10,
                  ),
              ...
              (function (t) {
                ...
                t
                  ? (c.setAttribute("preserveAspectRatio", "xMinYMin meet"),
                    c.setAttribute("viewBox", "0 0 " + (s + i) + " " + (r + n)))
                  : (c.setAttribute("width", (s + i).toString()),
                    c.setAttribute("height", (r + n).toString()));
              })(l));
        }).observe(c, { attributes: !1, subtree: !0, childList: !0 }),
        t.appendChild(c),
        e &&
          e.responsive &&
          t.setAttribute(
                    ...
                    (function (t) {
                      ...
                      var e = t.hash,
                        r = (function (t) {
                          ...
                          return (
                            e.setAttribute("cx", t.radius.toString()),
                            e.setAttribute("cy", t.radius.toString()),
                            e.setAttribute("r", t.radius.toString()),
                      ...
                      n.setAttribute("clip-path", "url(#" + s + ")"),
                        n.setAttribute("stroke", t.style.dot.strokeColor || "");
                      var a = t.style.dot.strokeWidth
                        ? 2 * t.style.dot.strokeWidth
                        : 0;
                      ...
                      return R({
                        ...
                        onMouseOver: function () {
                          !(function (t) {
                            if (
                              c.firstChild &&
                              (!m.isVertical || m.mode === O.Compact) &&
                              (!m.isVertical || t.style.hasTooltipInCompactMode)
                            ) {
                              var e = t.renderTooltip
                                ? t.renderTooltip(t)
                                : (function (t) {
                                    var e = j({ d: "", fill: "#EEE" }),
                                      r = k({
                        ...
                        children: [
                          ((o = [r, i]),
                          (l = document.createElementNS(B, "defs")),
                    ...
                    (function (e) {
                      ...
                      return e.parents.map(function (s) {
                        ...
                        var n = m.reverseArrow
                            ? { x: r + (i.x - e.x), y: r + (i.y - e.y) }
                            : { x: r, y: r },
                          a = j({
                            d: S(m, i, e),
                            fill: m.template.arrow.color || "",
                          });
                        return R({ translate: n, children: [a] });
                      });
                    })(e),
                    [
                      R({
                        ...
                        children: [
                          (function (t) {
                            ...
                            if (t.renderMessage)
                              return (
                                p((e = R({ children: [] }))),
                                e.appendChild(t.renderMessage(t)),
                                f(t, e),
                                e
                              );
                            var r = k({
                            ...
                            if (
                              ((e = R({
                                translate: { x: 0, y: t.style.dot.size },
                                children: [r],
                              })),
                              t.body)
                            ) {
                              var s = (function (t) {
                                ...
                                e.setAttribute("width", t.width.toString()),
                                  t.translate &&
                                    (e.setAttribute(
                                      "x",
                                      t.translate.x.toString(),
                                    ),
                                    e.setAttribute(
                                      "y",
                                      t.translate.y.toString(),
                                    ));
                          ...
                          (function (t) {
                            return Array.from(m.branches.values()).map(
                              function (e) {
                                if (!e.style.label.display) return null;
                                if (
                                  !m.branchLabelOnEveryCommit ||
                                  t.showLabel
                                ) {
                                ...
                                var s,
                                  n = e.renderLabel
                                    ? e.renderLabel(e)
                                    : N(e, t);
                                if (m.isVertical) s = R({ children: [n] });
                                else {
                                  var a = 2 * t.style.dot.size;
                                  s = R({
                                    translate: { x: t.x, y: a + 10 },
                                    children: [n],
                                  });
                                }
                                return (
                              ...
                              ? m.isHorizontal
                                ...
                                : t.tags.map(function (e) {
                                    ...
                                    return (
                                      s.setAttribute(
                                        "data-offset",
                                        e.style.pointerWidth.toString(),
                                      ),
                                      (function (t, e) {
                                        i[t.hashAbbrev] || b(t),
                                          i[t.hashAbbrev].tags.push(e);
                                      })(t, s),
                                      s
                                    );
                                  })
      ...
      function d(t, e) {
        ...
        t.setAttribute(
          "transform",
          r.replace(/translate\(([\d\.]+),/, "translate(" + e + ","),
        );
      }
      function p(t) {
        function e(t) {
        ...
        }).observe(t, { attributes: !1, subtree: !1, childList: !0 });
      }
      function g(t) {
        var e = t.x,
          r = t.y;
      ...
      function b(t) {
        i[t.hashAbbrev] = { branchLabel: null, tags: [], message: null };
      }
    }),
    (t.templateExtend = M),
